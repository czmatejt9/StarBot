...
import aiosqlite
import random
from bot import StarCityBot, logger, GAMBLE_RANDOM
from .utils import my_math

logger.name = __name__

CURRENCY_EMOTE = "<:SMURFPENIZE:1063440423625965578>"
...
# #############################################TASKS#########################################################
    ...
    async def leaderboard(self, ctx: commands.Context):
        ...
        async with self.bot.db.cursor() as cursor:
            await cursor.execute("SELECT user_id, wallet + bank AS balance FROM users ORDER BY balance DESC LIMIT 11")
